...
namespace ultrabus {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    std::unique_ptr<dbus_type> dbus_arg_parser::operator() (const std::string& signature,
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    std::unique_ptr<dbus_type> dbus_arg_parser::parse_dbus_arg_string (const char* signature,
                                                                       ...
                                                                       bool allow_dict_entry_sig)
    {
        ...
        std::unique_ptr<dbus_type> value (nullptr);
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    dbus_basic dbus_arg_parser::parse_dbus_basic_arg_string (const char* signature,
                                                             const char* value_buffer,
                                                             std::pair<size_t, size_t>& len,
                                                             bool& ok)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    dbus_array dbus_arg_parser::parse_dbus_array_arg_string (const char* signature,
                                                             const char* value_buffer,
                                                             std::pair<size_t, size_t>& len,
                                                             bool& ok)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    dbus_struct dbus_arg_parser::parse_dbus_struct_arg_string (const char* signature,
                                                               const char* value_buffer,
                                                               std::pair<size_t, size_t>& len,
                                                               bool& ok)
    {
    ...
    //--------------------------------------------------------------------------
    dbus_variant dbus_arg_parser::parse_dbus_variant_arg_string (const char* signature,
                                                                 const char* value_buffer,
                                                                 std::pair<size_t, size_t>& len,
                                                                 bool& ok)
    {
    ...
    //--------------------------------------------------------------------------
    //--------------------------------------------------------------------------
    dbus_dict_entry dbus_arg_parser::parse_dbus_dict_entry_arg_string (const char* signature,
                                                                       const char* value_buffer,
                                                                       std::pair<size_t, size_t>& len,
                                                                       bool& ok)
    {
